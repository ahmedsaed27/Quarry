...
class MaterialsPolicy
{
    ...
    {
        return $user->can('view_any_materials');
    }
    ...
    {
        return $user->can('view_materials');
    }
    ...
    {
        return $user->can('create_materials');
    }
    ...
    {
        return $user->can('update_materials');
    }
    ...
    {
        return $user->can('delete_materials');
    }
    ...
    {
        return $user->can('delete_any_materials');
    }
     ...
     */
    public function replicate(User $user, Materials $materials): bool
    {
