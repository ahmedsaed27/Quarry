...
class SupplyOrderPolicy
{
    ...
    {
        return $user->can('view_any_supply::order');
    }
    ...
    {
        return $user->can('view_supply::order');
    }
    ...
    {
        return $user->can('create_supply::order');
    }
    ...
    {
        return $user->can('update_supply::order');
    }
    ...
    {
        return $user->can('delete_supply::order');
    }
    ...
    {
        return $user->can('delete_any_supply::order');
    }
     ...
     */
    public function replicate(User $user, SupplyOrder $supplyOrder): bool
    {
